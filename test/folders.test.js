...
describe('Noteful API - Folders', function() {
  before(function() {
    return (
      mongoose
        ...
        // Promise.all([Note.deleteMany(), Folder.deleteMany(), User.deleteMany()]));
  ...
  afterEach(function() {
    sandbox.restore();
    // Promise.all([Note.deleteMany(), Folder.deleteMany()]);
  ...
  describe('GET /api/folders', function() {
    ...
    it('should catch errors and respond properly', function() {
      sandbox
        .stub(Folder.schema.options.toObject, 'transform')
        .throws('FakeError');
      return chai
        .request(app)
        .get('/api/folders')
